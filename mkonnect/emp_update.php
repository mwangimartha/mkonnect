...
//declare variable
 ...
 $job_category=$_POST['txt_category'];
...
$insert_acc="INSERT INTO employer_jobs (job_title,company_name,job_description,job_category,job_experience,company_website,employer_id,location) VALUES ('$job_title','$company_name','$job_description','$job_category','$experience','$website','$employer_id','$job_location')";
