...
<div id="success" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
    	...
    	<center><p class="text-warning" style="font-size:1.5em;"> Click Next to Update your profile and Apply for the Available Job
    	</center>
...
$select_acc="SELECT * FROM users WHERE email = '".$email."'";
...
$insert_acc="INSERT INTO users (email,password) VALUES ('$email',md5('$user_pass'))";
